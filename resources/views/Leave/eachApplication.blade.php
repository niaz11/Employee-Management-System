...
<div class="row" style="margin-top: 50px;">
    ...
    <div class="col-lg-12">
        <h1 class="page-header" style="font-size: 20px;">Leave Application
        </h1>
        <ol class="breadcrumb">
            <li><a href="/">Home</a>
            </li>
        ...
        <div class="col-lg-8 col-lg-offset-2">
            ...
            <div class="well well-sm">
                ...
                <div class="row">
                    <div class="col-md-6">
                        {!! Form::model($user, ['route' => ['Leave.update', $user->id], 'method' => 'PUT']) !!}
                    ...
                    <div class="col-md-6">
                        <a href="{{ route('Leave.reject', $user->id) }}" class="btn btn-danger btn-lg btn-block">Reject</a>
                    </div>
                </div>             
            </div>
        </div>
